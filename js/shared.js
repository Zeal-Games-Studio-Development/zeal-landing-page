...
const i18n = {
  vi: {
    ...
    // FOOTER
    footer_desc:'Chúng tôi tạo ra những trải nghiệm game mobile và ứng dụng tiện ích không thể quên được. Từ Việt Nam, cho thế giới.',
  ...
  en: {
    ...
    footer_desc:'We create unforgettable mobile game and app experiences. From Vietnam, for the world.',
...
html.setAttribute('data-theme', localStorage.getItem('zg-theme') || 'dark');
